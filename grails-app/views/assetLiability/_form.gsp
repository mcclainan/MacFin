...
<div class="fieldcontain ${hasErrors(bean: assetLiabilityInstance, field: 'assetLiabilityClass', 'error')} required">
	...
	<g:select id="assetLiabilityClass" name="assetLiabilityClass.id" from="${assetLiability.AssetLiabilityClass.list()}" optionKey="id" required="" value="${assetLiabilityInstance?.assetLiabilityClass?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: assetLiabilityInstance, field: 'value', 'error')} required">
	...
	<g:field name="value" value="${fieldValue(bean: assetLiabilityInstance, field: 'value')}" required=""/>
...
<div class="fieldcontain ${hasErrors(bean: assetLiabilityInstance, field: 'interestRate', 'error')} ">
	...
	<g:field name="interestRate" value="${fieldValue(bean: assetLiabilityInstance, field: 'interestRate')}"/>
...
<div class="fieldcontain ${hasErrors(bean: assetLiabilityInstance, field: 'creditLimit', 'error')} ">
	...
	<g:field name="creditLimit" value="${fieldValue(bean: assetLiabilityInstance, field: 'creditLimit')}"/>

</div>

<div class="fieldcontain ${hasErrors(bean: assetLiabilityInstance, field: 'categories', 'error')} ">
	<label for="categories">
		<g:message code="assetLiability.categories.label" default="Categories" />
...
<li class="add">
<g:link controller="category" action="create" params="['assetLiability.id': assetLiabilityInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'category.label', default: 'Category')])}</g:link>
</li>
</ul>
