...
<html>
	...
	<body>
		<a href="#edit-assetLiability" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		<div id="edit-assetLiability" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:assetLiabilityInstance, action:'update']" method="PUT" >
