...
<html>
	...
	<body>
		...
		<div id="show-assetLiabilityClass" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:assetLiabilityClassInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${assetLiabilityClassInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
