...
<br/>
Start Date:
<g:datePicker name="startDate" precision="day" value="${plannedTransactionCommmand?.startDate?:new Date()}"  relativeYears="[0..5]"/><br/>		
<br/>
End Date:&nbsp;
<g:datePicker name="endDate" precision="day" value="${plannedTransactionCommmand?.endDate?:new Date()+1}"  relativeYears="[0..5]"/><br/>
<br/>
