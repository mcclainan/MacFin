...
<div class="fieldcontain ${hasErrors(bean: transactionInstance, field: 'category', 'error')} required">
	...
	<g:select id="category" name="category.id" from="${category.Category.list()}" optionKey="id" required="" value="${transactionInstance?.category?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: transactionInstance, field: 'budgetItem', 'error')} ">
	...
	<g:select id="budgetItem" name="budgetItem.id" from="${planning.BudgetItem.list()}" optionKey="id" value="${transactionInstance?.budgetItem?.id}" class="many-to-one" noSelection="['null': '']"/>
...
<div class="fieldcontain ${hasErrors(bean: transactionInstance, field: 'combinationId', 'error')} ">
	...
	<g:field name="combinationId" type="number" value="${transactionInstance.combinationId}"/>
