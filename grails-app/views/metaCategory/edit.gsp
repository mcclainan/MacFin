...
<html>
	...
	<body>
		<a href="#edit-metaCategory" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		<div id="edit-metaCategory" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:metaCategoryInstance, action:'update']" method="PUT" >
