...
<div class="fieldcontain ${hasErrors(bean: categoryInstance, field: 'displayOnMobile', 'error')} ">
	<label for="displayOnMobile">
		<g:message code="category.displayOnMobile.label" default="Display On Mobile" />
		
	</label>
	<g:select name="displayOnMobile" from="${categoryInstance.constraints.displayOnMobile.inList}" value="${categoryInstance?.displayOnMobile}" valueMessagePrefix="category.displayOnMobile" noSelection="['': '']"/>

</div>

<div class="fieldcontain ${hasErrors(bean: categoryInstance, field: 'assetLiability', 'error')} ">
	<label for="assetLiability">
		<g:message code="category.assetLiability.label" default="Asset Liability" />
		
	</label>
	<g:select id="assetLiability" name="assetLiability.id" from="${assetLiability.AssetLiability.list()}" optionKey="id" value="${categoryInstance?.assetLiability?.id}" class="many-to-one" noSelection="['null': '']"/>

</div>

<div class="fieldcontain ${hasErrors(bean: categoryInstance, field: 'assetLiabilityAction', 'error')} ">
	<label for="assetLiabilityAction">
		<g:message code="category.assetLiabilityAction.label" default="Asset Liability Action" />
		
	</label>
	<g:textField name="assetLiabilityAction" value="${categoryInstance?.assetLiabilityAction}"/>
...
<div class="fieldcontain ${hasErrors(bean: categoryInstance, field: 'metaCategory', 'error')} required">
	...
	<g:select id="metaCategory" name="metaCategory.id" from="${category.MetaCategory.list()}" optionKey="id" required="" value="${categoryInstance?.metaCategory?.id}" class="many-to-one"/>
